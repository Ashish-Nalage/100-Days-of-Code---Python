...
tomato_png = PhotoImage(file="./Day-028/pomodoro-project/tomato.png")
canvas.create_image(100, 112, image=tomato_png)
timer_text = canvas.create_text(100, 130, text="00:00", font=("Arial", 34, "bold"), fill="white")



timer_lable = Label(text="Timer", font=(FONT_NAME, 50, "normal"), fg=GREEN, bg=YELLOW)
check_mark_lable = Label(font=(FONT_NAME, 18, "normal"), bg=YELLOW, fg=GREEN)
